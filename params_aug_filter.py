...
def get_params():
    ...
    args.add_argument("-bs", "--batch_size", default=10, type=int)
    ...
    args.add_argument("-amn", "--aug_max_num", default=5, type=int)
    args.add_argument("-gpu", "--device", default=0, type=int)

    args.add_argument("-prefix", "--prefix", default="default_pt_3s", type=str)
    args.add_argument(
...
data_dir = {
    ...
    "task_aug_dic":'/augmented_by_relation.json'
}
